...
const BoardTitle = ({ onSearch, onWriteLink }: PropsWithChildren<IBoardTitleProps>) => {
     ...
     <div className="con_header no_border board-title" >
       <div className="board_search_wrap">
        <div className="form-row align-items-center">
          ...
          <div>
            <button className="btn btn_centero_default" type="button" onClick={onWriteLink}>{t('CMM_T_0003.value')}</button>
          </div>
      </div>
    </>
  );
