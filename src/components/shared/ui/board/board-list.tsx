...
const defaultTitle = () => (<BoardTitle />);
const defaultFooter = () => "dksksk";
const DefaultBoardList = <T extends object>({ className }: PropsWithChildren<IBoardListProps>) => {
