...
Example:
    ...
    <button className="btn btn-material-deep-purple">Deep purple button</button>
...
Remember to use the proper HTML markup to get radio and checkboxes styled correctly (choose between _radio_ or _checkbox_):

    <div className="radio/checkbox radio-primary">
        <label>
...
The syntax to add a Material icon is:
     ...
     <i className="icon icon-material-favorite"></i>
...
You may want to set a custom color to the ripples of a specific element, to do so write:
    ...
    <button className="btn btn-default" data-ripple-color="#F0F0F0">Custom ripple</button>
