...
(function($){ 	
	...
	var init = function( tb, options){	
		...
		t.addClass(SIGNATURE).attr(ID, id).before('<div className="JCLRgrips"/>');	//the grips container object is added. Signature class forces table rendering in fixed-layout mode to prevent column's min-width
	...
	var createGrips = function(t){	
		...
		th.each(function(i){						//iterate through the table column headers			
			...
			var g = $(t.gc.append('<div className="JCLRgrip"></div>')[0].lastChild); //add the visual node to be used as grip
            g.append(dc ? "": t.opt.gripInnerHtml).append('<div className="'+SIGNATURE+'"></div>');
